import{d as N,c as v,t as y,a as Ie,b as u,o as h,u as Pe,e as $,i as ce,f as k,_ as re,w as ie,g as oe,F as C,r as O,h as fn,n as Zt,j as cn,k as dn,s as U,l as ot,m as Y,p as mn,q as ea,v as pn,T as hn,x as vn,y as gn,z as yn,A as st,B as ae,C as bn,D as kn}from"./index-BEsAS5GN.js";import{_ as X,u as kt,l as xn}from"./bodyScrollLock-CF8BDXwq.js";const wn={class:"flex w-full items-center gap-2 text-sm text-ink"},_n={key:0,class:"shrink-0 font-medium"},jn=["min","value","inputmode"],Sn=N({__name:"BaseInput",props:{modelValue:{},label:{default:""},min:{default:0},inputmode:{default:"numeric"}},emits:["update:modelValue"],setup(e,{emit:t}){const a=t;return(n,r)=>(h(),v("label",wn,[e.label?(h(),v("span",_n,y(e.label),1)):Ie("",!0),u("input",{class:"w-full rounded border border-clay/20 bg-white px-2 py-[0.275rem] outline-none transition focus:border-clay",type:"number",min:e.min,value:e.modelValue,inputmode:e.inputmode,onInput:r[0]||(r[0]=o=>a("update:modelValue",o.target.value))},null,40,jn)]))}}),An={"data-testid":"practice-toolbar",class:"section-card space-y-3"},$n={class:"flex flex-wrap gap-3"},In={class:"grid gap-3 md:grid-cols-[minmax(0,1fr)_auto]"},Pn={class:"flex items-center text-xs text-ink/70"},Cn={class:"flex flex-wrap gap-3"},On={class:"flex items-center justify-between gap-2"},En={class:"flex flex-wrap gap-2"},Tn=N({__name:"PracticeToolbar",props:{hasLatestResult:{type:Boolean}},emits:["startExam","clearLatestResult"],setup(e,{emit:t}){const a=t,n=Pe(),r=n.includeHiragana,o=n.includeKatakana,i=n.enableSokuon,s=n.enableYoonChoon,l=n.showArchaicKana,f=n.questionCountInput,p=n.allKanaSelected,m=n.dakuonSelected,x=n.canStartExam,j=n.selectedKanaCount,w=n.recommendedQuestionCount;return(A,_)=>(h(),v("section",An,[u("div",$n,[$(X,{modelValue:k(r),"onUpdate:modelValue":_[0]||(_[0]=d=>ce(r)?r.value=d:null),label:"題目包含：平假名"},null,8,["modelValue"]),$(X,{modelValue:k(o),"onUpdate:modelValue":_[1]||(_[1]=d=>ce(o)?o.value=d:null),label:"題目包含：片假名"},null,8,["modelValue"]),$(X,{"data-testid":"toggle-all-kana","model-value":k(p),label:"全選／全不選","onUpdate:modelValue":k(n).toggleAllKana},null,8,["model-value","onUpdate:modelValue"]),$(X,{"model-value":k(m),label:"濁音／半濁音","onUpdate:modelValue":k(n).toggleDakuon},null,8,["model-value","onUpdate:modelValue"])]),u("div",In,[$(Sn,{"data-testid":"question-count-input",label:"題數","model-value":k(f),"onUpdate:modelValue":k(n).setQuestionCount},null,8,["model-value","onUpdate:modelValue"]),u("p",Pn," 目前勾選 "+y(k(j))+" 個假名，依範圍建議 "+y(k(w))+" 題。 ",1)]),u("div",Cn,[$(X,{modelValue:k(i),"onUpdate:modelValue":_[2]||(_[2]=d=>ce(i)?i.value=d:null),label:"促音"},null,8,["modelValue"]),$(X,{modelValue:k(s),"onUpdate:modelValue":_[3]||(_[3]=d=>ce(s)?s.value=d:null),label:"拗音／合拗音／長音符"},null,8,["modelValue"])]),u("div",null,[$(X,{modelValue:k(l),"onUpdate:modelValue":_[4]||(_[4]=d=>ce(l)?l.value=d:null),label:"古語假名"},null,8,["modelValue"])]),u("div",On,[u("div",En,[$(re,{"data-testid":"start-exam-button",variant:"primary",disabled:!k(x),onClick:_[5]||(_[5]=d=>a("startExam"))},{default:ie(()=>[..._[7]||(_[7]=[oe(" 送出 ",-1)])]),_:1},8,["disabled"]),$(re,{variant:"secondary",onClick:k(n).resetAll},{default:ie(()=>[..._[8]||(_[8]=[oe("重置",-1)])]),_:1},8,["onClick"])]),$(re,{"data-testid":"toolbar-clear-result-button",variant:"ghost",disabled:!e.hasLatestResult,onClick:_[6]||(_[6]=d=>a("clearLatestResult"))},{default:ie(()=>[..._[9]||(_[9]=[oe(" 清除結果 ",-1)])]),_:1},8,["disabled"])])]))}}),Fn={class:"section-card space-y-2"},Nn={class:"table-shell"},Rn={"data-testid":"practice-seion-table",class:"fixed-grid-table practice-kana-table"},Ln=["onClick"],Mn=["checked"],Dn={class:"kana-header border-b border-clay/10 px-1 py-2"},zn=["onClick"],Un=["checked"],Wn=["onClick"],Kn=["checked"],Bn={class:"practice-kana-text-stack"},Vn={class:"practice-kana-main-text font-semibold"},Yn={class:"practice-kana-romaji-text text-ink/70"},Hn={key:1,class:"practice-kana-placeholder flex min-h-[58px] items-center justify-center whitespace-nowrap text-ink/40"},Gn=N({__name:"SeionTable",setup(e){const t=Pe();function a(i){return i.archaic===!0&&!t.showArchaicKana.value}function n(i,s,l){return l?.id??`${i}-${s}`}function r(i){t.toggleKana(i,!t.isKanaChecked(i.id))}function o(i){return`${i.hiragana} / ${i.katakana}`}return(i,s)=>(h(),v("section",Fn,[s[1]||(s[1]=u("div",{class:"flex items-center justify-between gap-2"},[u("h2",{class:"text-sm font-semibold text-ink"},"清音")],-1)),u("div",Nn,[u("table",Rn,[u("thead",null,[u("tr",null,[s[0]||(s[0]=u("th",{class:"kana-header border-b border-clay/15 px-1 py-2"},"行／段",-1)),(h(!0),v(C,null,O(k(fn),l=>(h(),v("th",{key:l.key,class:"kana-header border-b border-l border-clay/15 px-1 py-2"},[u("button",{type:"button",class:"practice-kana-header-button flex w-full flex-col items-center justify-center gap-1 whitespace-nowrap",onClick:f=>k(t).toggleColumn(l.key,!k(t).isColumnChecked(l.key))},[u("input",{class:"pointer-events-none h-3.5 w-3.5",type:"checkbox",checked:k(t).isColumnChecked(l.key)},null,8,Mn),u("span",null,y(l.label),1)],8,Ln)]))),128))])]),u("tbody",null,[(h(!0),v(C,null,O(k(cn),l=>(h(),v("tr",{key:l.rowKey},[u("th",Dn,[u("button",{type:"button",class:"practice-kana-header-button flex w-full flex-col items-center justify-center gap-1 whitespace-nowrap",onClick:f=>k(t).toggleRow(l.rowKey,!k(t).isRowChecked(l.rowKey))},[u("input",{class:"pointer-events-none h-3.5 w-3.5",type:"checkbox",checked:k(t).isRowChecked(l.rowKey)},null,8,Un),u("span",null,y(l.label),1)],8,zn)]),(h(!0),v(C,null,O(l.cells,(f,p)=>(h(),v("td",{key:n(l.rowKey,p,f),class:Zt(["border-b border-l border-clay/10 p-1 align-middle text-center",f&&k(t).isKanaChecked(f.id)?"kana-cell-selected":""])},[f&&!a(f)?(h(),v("button",{key:0,type:"button",class:"practice-kana-button flex min-h-[58px] w-full flex-col items-center justify-center gap-1 whitespace-nowrap",onClick:m=>f.selectable===!1?void 0:r(f)},[f.selectable!==!1?(h(),v("input",{key:0,class:"pointer-events-none h-3.5 w-3.5",type:"checkbox",checked:k(t).isKanaChecked(f.id)},null,8,Kn)):Ie("",!0),u("div",Bn,[u("div",Vn,y(o(f)),1),u("div",Yn,y(f.romaji),1)])],8,Wn)):(h(),v("div",Hn," - "))],2))),128))]))),128))])])])]))}}),qn={class:"section-card space-y-2"},Xn={class:"table-shell"},Jn={"data-testid":"practice-dakuon-table",class:"fixed-grid-table practice-kana-table"},Qn=["onClick"],Zn=["checked"],er={class:"practice-kana-text-stack"},tr={class:"practice-kana-main-text font-semibold"},ar={class:"practice-kana-romaji-text text-ink/70"},nr={key:1,class:"practice-kana-placeholder flex min-h-[58px] items-center justify-center whitespace-nowrap text-ink/40"},rr=N({__name:"DakuonTable",setup(e){const t=Pe();function a(r,o,i){return i?.id??`${r}-${o}`}function n(r){t.toggleKana(r,!t.isKanaChecked(r.id))}return(r,o)=>(h(),v("section",qn,[o[0]||(o[0]=u("div",{class:"flex items-center justify-between gap-2"},[u("h2",{class:"text-sm font-semibold text-ink"},"濁音／半濁音")],-1)),u("div",Xn,[u("table",Jn,[u("tbody",null,[(h(!0),v(C,null,O(k(dn),i=>(h(),v("tr",{key:i.rowKey},[(h(!0),v(C,null,O(i.cells,(s,l)=>(h(),v("td",{key:a(i.rowKey,l,s),class:Zt(["border-b border-l border-clay/10 p-1 align-middle text-center",s&&k(t).isKanaChecked(s.id)?"kana-cell-selected":""])},[s?(h(),v("button",{key:0,type:"button",class:"practice-kana-button flex min-h-[58px] w-full flex-col items-center justify-center gap-1 whitespace-nowrap",onClick:f=>n(s)},[u("input",{class:"pointer-events-none h-3.5 w-3.5",type:"checkbox",checked:k(t).isKanaChecked(s.id)},null,8,Zn),u("div",er,[u("div",tr,y(s.hiragana)+" / "+y(s.katakana),1),u("div",ar,y(s.romaji),1)])],8,Qn)):(h(),v("div",nr," - "))],2))),128))]))),128))])])])]))}}),ir=[{label:"ん / ン",values:["さんぽ（sanpo）：散步","しんぶん（shinbun）：報紙","てんき（tenki）：天氣"]}],or=[{label:"っ / ッ",values:["がっこう（gakkou）：學校","きって（kitte）：郵票","ざっし（zasshi）：雜誌"]}],ta=[{key:"ya",kana:"や / ヤ",romaji:"ya"},{key:"yu",kana:"ゆ / ユ",romaji:"yu"},{key:"yo",kana:"よ / ヨ",romaji:"yo"}],sr=[{header:{key:"ki",kana:"き / キ",romaji:"ki"},cells:[{kana:"きゃ / キャ",romaji:"kya"},{kana:"きゅ / キュ",romaji:"kyu"},{kana:"きょ / キョ",romaji:"kyo"}]},{header:{key:"shi",kana:"し / シ",romaji:"shi"},cells:[{kana:"しゃ / シャ",romaji:"sha"},{kana:"しゅ / シュ",romaji:"shu"},{kana:"しょ / ショ",romaji:"sho"}]},{header:{key:"chi",kana:"ち / チ",romaji:"chi"},cells:[{kana:"ちゃ / チャ",romaji:"cha"},{kana:"ちゅ / チュ",romaji:"chu"},{kana:"ちょ / チョ",romaji:"cho"}]},{header:{key:"ni",kana:"に / ニ",romaji:"ni"},cells:[{kana:"にゃ / ニャ",romaji:"nya"},{kana:"にゅ / ニュ",romaji:"nyu"},{kana:"にょ / ニョ",romaji:"nyo"}]},{header:{key:"hi",kana:"ひ / ヒ",romaji:"hi"},cells:[{kana:"ひゃ / ヒャ",romaji:"hya"},{kana:"ひゅ / ヒュ",romaji:"hyu"},{kana:"ひょ / ヒョ",romaji:"hyo"}]},{header:{key:"mi",kana:"み / ミ",romaji:"mi"},cells:[{kana:"みゃ / ミャ",romaji:"mya"},{kana:"みゅ / ミュ",romaji:"myu"},{kana:"みょ / ミョ",romaji:"myo"}]},{header:{key:"ri",kana:"り / リ",romaji:"ri"},cells:[{kana:"りゃ / リャ",romaji:"rya"},{kana:"りゅ / リュ",romaji:"ryu"},{kana:"りょ / リョ",romaji:"ryo"}]}],lr=[{header:{key:"gi",kana:"ぎ / ギ",romaji:"gi"},cells:[{kana:"ぎゃ / ギャ",romaji:"gya"},{kana:"ぎゅ / ギュ",romaji:"gyu"},{kana:"ぎょ / ギョ",romaji:"gyo"}]},{header:{key:"ji",kana:"じ / ジ",romaji:"ji"},cells:[{kana:"じゃ / ジャ",romaji:"ja"},{kana:"じゅ / ジュ",romaji:"ju"},{kana:"じょ / ジョ",romaji:"jo"}]},{header:{key:"bi",kana:"び / ビ",romaji:"bi"},cells:[{kana:"びゃ / ビャ",romaji:"bya"},{kana:"びゅ / ビュ",romaji:"byu"},{kana:"びょ / ビョ",romaji:"byo"}]},{header:{key:"pi",kana:"ぴ / ピ",romaji:"pi"},cells:[{kana:"ぴゃ / ピャ",romaji:"pya"},{kana:"ぴゅ / ピュ",romaji:"pyu"},{kana:"ぴょ / ピョ",romaji:"pyo"}]}],ur=[{key:"a",kana:"ア",romaji:"a"},{key:"i",kana:"イ",romaji:"i"},{key:"u",kana:"ウ",romaji:"u"},{key:"e",kana:"エ",romaji:"e"},{key:"o",kana:"オ",romaji:"o"}],fr=[{header:{key:"f",kana:"フ系",romaji:"f"},cells:[{kana:"ファ",romaji:"fa"},{kana:"フィ",romaji:"fi"},{kana:"フ",romaji:"fu"},{kana:"フェ",romaji:"fe"},{kana:"フォ",romaji:"fo"}]},{header:{key:"v",kana:"ヴ系",romaji:"v"},cells:[{kana:"ヴァ",romaji:"va"},{kana:"ヴィ",romaji:"vi"},{kana:"ヴ",romaji:"vu"},{kana:"ヴェ",romaji:"ve"},{kana:"ヴォ",romaji:"vo"}]},{header:{key:"ty",kana:"ティ系",romaji:"ty"},cells:[{kana:"テャ",romaji:"tya"},{kana:"ティ",romaji:"ti"},{kana:"テュ",romaji:"tyu"},{kana:"テェ",romaji:"tye"},{kana:"テョ",romaji:"tyo"}]},{header:{key:"dy",kana:"ディ系",romaji:"dy"},cells:[{kana:"デャ",romaji:"dya"},{kana:"ディ",romaji:"di"},{kana:"デュ",romaji:"dyu"},{kana:"デェ",romaji:"dye"},{kana:"デョ",romaji:"dyo"}]},{header:{key:"t",kana:"ト系",romaji:"t"},cells:[{kana:"-",available:!1},{kana:"ティ",romaji:"ti"},{kana:"トゥ",romaji:"tu"},{kana:"-",available:!1},{kana:"-",available:!1}]},{header:{key:"sh",kana:"シ系",romaji:"sh"},cells:[{kana:"シャ",romaji:"sha"},{kana:"シィ",romaji:"shi"},{kana:"シュ",romaji:"shu"},{kana:"シェ",romaji:"she"},{kana:"ショ",romaji:"sho"}]},{header:{key:"j",kana:"ジ系",romaji:"j"},cells:[{kana:"ジャ",romaji:"ja"},{kana:"ジィ",romaji:"ji"},{kana:"ジュ",romaji:"ju"},{kana:"ジェ",romaji:"je"},{kana:"ジョ",romaji:"jo"}]},{header:{key:"ch",kana:"チェ系",romaji:"ch"},cells:[{kana:"チャ",romaji:"cha"},{kana:"チィ",romaji:"chi"},{kana:"チュ",romaji:"chu"},{kana:"チェ",romaji:"che"},{kana:"チョ",romaji:"cho"}]},{header:{key:"ts",kana:"ツ系",romaji:"ts"},cells:[{kana:"ツァ",romaji:"tsa"},{kana:"ツィ",romaji:"tsi"},{kana:"ツ",romaji:"tsu"},{kana:"ツェ",romaji:"tse"},{kana:"ツォ",romaji:"tso"}]},{header:{key:"w",kana:"ウ系",romaji:"w"},cells:[{kana:"ワ",romaji:"wa"},{kana:"ウィ",romaji:"wi"},{kana:"ウ",romaji:"wu"},{kana:"ウェ",romaji:"we"},{kana:"ウォ",romaji:"wo"}]}],cr=[{id:"loanword-rule",kind:"rule",groupTitle:"外來語通常使用長音符ー",ruleText:"片假名借詞常用長音符拉長母音，閱讀時可直接把前一個母音延長。"},{id:"loanword-example-1",kind:"example",groupTitle:"外來語通常使用長音符ー",example:{kana:"ケーキ",romaji:"keki",translation:"蛋糕"}},{id:"loanword-example-2",kind:"example",groupTitle:"外來語通常使用長音符ー",example:{kana:"スーパー",romaji:"supa",translation:"超市"}},{id:"loanword-example-3",kind:"example",groupTitle:"外來語通常使用長音符ー",example:{kana:"コーヒー",romaji:"kohi",translation:"咖啡"}},{id:"ei-rule",kind:"rule",groupTitle:"え段假名 + い",ruleText:"很多字會以 え段假名接 い 來表示長音，讀音通常把 e 音拉長。"},{id:"ei-example-1",kind:"example",groupTitle:"え段假名 + い",example:{kana:"せんせい",romaji:"sensei",translation:"老師"}},{id:"ei-example-2",kind:"example",groupTitle:"え段假名 + い",example:{kana:"えいが",romaji:"eiga",translation:"電影"}},{id:"ei-example-3",kind:"example",groupTitle:"え段假名 + い",example:{kana:"とけい",romaji:"tokei",translation:"手錶"}},{id:"ou-rule",kind:"rule",groupTitle:"お段假名 + う",ruleText:"很多字會以 お段假名接 う 表示長音，讀音通常把 o 音拉長。"},{id:"ou-example-1",kind:"example",groupTitle:"お段假名 + う",example:{kana:"とうきょう",romaji:"toukyou",translation:"東京"}},{id:"ou-example-2",kind:"example",groupTitle:"お段假名 + う",example:{kana:"がっこう",romaji:"gakkou",translation:"學校"}},{id:"ou-example-3",kind:"example",groupTitle:"お段假名 + う",example:{kana:"どうぶつ",romaji:"doubutsu",translation:"動物"}},{id:"same-vowel-rule",kind:"rule",groupTitle:"同一母音連續",ruleText:"有些字直接讓同一母音連續出現，閱讀時也要把母音自然拉長。"},{id:"same-vowel-example-1",kind:"example",groupTitle:"同一母音連續",example:{kana:"おおきい",romaji:"ookii",translation:"大的"}},{id:"same-vowel-example-2",kind:"example",groupTitle:"同一母音連續",example:{kana:"にいさん",romaji:"niisan",translation:"哥哥"}},{id:"same-vowel-example-3",kind:"example",groupTitle:"同一母音連續",example:{kana:"ちいさい",romaji:"chiisai",translation:"小的"}},{id:"au-rule",kind:"rule",groupTitle:"あ段 + う 不一定屬於規則長音",ruleText:"看到 a 段接 う 時，不要直接當成長音；有些詞其實是兩個音節或歷史假名遣。"},{id:"au-example-1",kind:"example",groupTitle:"あ段 + う 不一定屬於規則長音",example:{kana:"あう",romaji:"au",translation:"相遇"}},{id:"au-example-2",kind:"example",groupTitle:"あ段 + う 不一定屬於規則長音",example:{kana:"うたう",romaji:"utau",translation:"歌唱"}},{id:"au-example-3",kind:"example",groupTitle:"あ段 + う 不一定屬於規則長音",example:{kana:"かう",romaji:"kau",translation:"買（歷史假名遣）"}}],dr=[{kana:"ゔ / ヴ",romaji:"vu",description:"主要出現在外來語與近代記音，日常詞彙中不常見。"},{kana:"を / ヲ",romaji:"wo",description:"現代日語多作助詞使用，實際發音常接近 o。"},{kana:"ぢ / ヂ、づ / ヅ",romaji:"di / du",description:"常見於連濁或固定詞，現代拼寫與讀音需搭配單字一起記。"}],mr={class:"section-card space-y-2"},pr={class:"table-shell"},hr={class:"content-fit-table text-sm"},vr={class:"whitespace-nowrap border-b border-clay/10 px-2 py-2 text-center font-semibold text-ink"},gr={class:"border-b border-l border-clay/10 px-2 py-2 text-center text-ink/80"},yr={class:"space-y-1"},br=N({__name:"HatsuonSection",setup(e){return(t,a)=>(h(),v("section",mr,[a[0]||(a[0]=u("h2",{class:"text-sm font-semibold text-ink"},"撥音的發音規則：通常會依後方音節自然轉成接近鼻音的發音。",-1)),u("div",pr,[u("table",hr,[u("tbody",null,[(h(!0),v(C,null,O(k(ir),n=>(h(),v("tr",{key:n.label},[u("th",vr,y(n.label),1),u("td",gr,[u("div",yr,[(h(!0),v(C,null,O(n.values,r=>(h(),v("p",{key:r},y(r),1))),128))])])]))),128))])])])]))}}),kr={class:"section-card space-y-2"},xr={class:"table-shell"},wr={class:"content-fit-table text-sm"},_r={class:"whitespace-nowrap border-b border-clay/10 px-2 py-2 text-center font-semibold text-ink"},jr={class:"border-b border-l border-clay/10 px-2 py-2 text-center text-ink/80"},Sr={class:"space-y-1"},Ar=N({__name:"SokuonSection",setup(e){return(t,a)=>(h(),v("section",kr,[a[0]||(a[0]=u("h2",{class:"text-sm font-semibold text-ink"},"促音的發音規則：先短暫停頓，再把後面的子音清楚推出來。",-1)),u("div",xr,[u("table",wr,[u("tbody",null,[(h(!0),v(C,null,O(k(or),n=>(h(),v("tr",{key:n.label},[u("th",_r,y(n.label),1),u("td",jr,[u("div",Sr,[(h(!0),v(C,null,O(n.values,r=>(h(),v("p",{key:r},y(r),1))),128))])])]))),128))])])])]))}}),$r={class:"table-shell"},Ir={class:"fixed-grid-table practice-grid-table text-xs"},Pr={class:"practice-kana-text"},Cr={class:"practice-romaji-text"},Or={class:"practice-grid-header-cell border-b border-clay/10"},Er={class:"practice-kana-text"},Tr={class:"practice-romaji-text"},Fr={class:"practice-kana-text"},Nr={class:"practice-romaji-text"},Rr=N({__name:"SeionYoonSection",setup(e){return(t,a)=>a[0]||(U(-1,!0),(a[0]=u("section",{"data-testid":"seion-yoon-section",class:"section-card space-y-2"},[a[2]||(a[2]=u("h2",{class:"text-sm font-semibold text-ink"},"清音拗音：由 i 段假名接上小や・ゆ・よ，整體要一口氣連讀。",-1)),u("div",$r,[u("table",Ir,[u("thead",null,[u("tr",null,[a[1]||(a[1]=u("th",{class:"practice-grid-header-cell border-b border-clay/10"},null,-1)),(h(!0),v(C,null,O(k(ta),n=>(h(),v("th",{key:n.key,class:"practice-grid-header-cell border-b border-l border-clay/10"},[u("span",Pr,y(n.kana),1),u("span",Cr,y(n.romaji),1)]))),128))])]),u("tbody",null,[(h(!0),v(C,null,O(k(sr),n=>(h(),v("tr",{key:n.header.key},[u("th",Or,[u("span",Er,y(n.header.kana),1),u("span",Tr,y(n.header.romaji),1)]),(h(!0),v(C,null,O(n.cells,r=>(h(),v("td",{key:r.kana,class:"practice-grid-cell border-b border-l border-clay/10"},[u("span",Fr,y(r.kana),1),u("span",Nr,y(r.romaji),1)]))),128))]))),128))])])])])).cacheIndex=0,U(1),a[0])}}),Lr={class:"table-shell"},Mr={class:"fixed-grid-table practice-grid-table text-xs"},Dr={class:"practice-kana-text"},zr={class:"practice-romaji-text"},Ur={class:"practice-grid-header-cell border-b border-clay/10"},Wr={class:"practice-kana-text"},Kr={class:"practice-romaji-text"},Br={class:"practice-kana-text"},Vr={class:"practice-romaji-text"},Yr=N({__name:"DakuonYoonSection",setup(e){return(t,a)=>a[0]||(U(-1,!0),(a[0]=u("section",{"data-testid":"dakuon-yoon-section",class:"section-card space-y-2"},[a[2]||(a[2]=u("h2",{class:"text-sm font-semibold text-ink"},"合拗音：濁音與半濁音接上小や・ゆ・よ時，也要視為一個連續音節。",-1)),u("div",Lr,[u("table",Mr,[u("thead",null,[u("tr",null,[a[1]||(a[1]=u("th",{class:"practice-grid-header-cell border-b border-clay/10"},null,-1)),(h(!0),v(C,null,O(k(ta),n=>(h(),v("th",{key:n.key,class:"practice-grid-header-cell border-b border-l border-clay/10"},[u("span",Dr,y(n.kana),1),u("span",zr,y(n.romaji),1)]))),128))])]),u("tbody",null,[(h(!0),v(C,null,O(k(lr),n=>(h(),v("tr",{key:n.header.key},[u("th",Ur,[u("span",Wr,y(n.header.kana),1),u("span",Kr,y(n.header.romaji),1)]),(h(!0),v(C,null,O(n.cells,r=>(h(),v("td",{key:r.kana,class:"practice-grid-cell border-b border-l border-clay/10"},[u("span",Br,y(r.kana),1),u("span",Vr,y(r.romaji),1)]))),128))]))),128))])])])])).cacheIndex=0,U(1),a[0])}}),Hr={class:"table-shell"},Gr={class:"fixed-grid-table practice-grid-table text-xs"},qr={class:"practice-kana-text"},Xr={class:"practice-romaji-text"},Jr={class:"practice-grid-header-cell border-b border-clay/10"},Qr={class:"practice-kana-text"},Zr={class:"practice-romaji-text"},ei={key:0,class:"practice-placeholder-text"},ti={class:"practice-kana-text"},ai={class:"practice-romaji-text"},ni=N({__name:"LoanwordSection",setup(e){return(t,a)=>a[0]||(U(-1,!0),(a[0]=u("section",{"data-testid":"loanword-section",class:"section-card space-y-2"},[a[2]||(a[2]=u("h2",{class:"text-sm font-semibold text-ink"},"外來語擴張：片假名會用額外組合來模擬日語原本沒有的音。",-1)),u("div",Hr,[u("table",Gr,[u("thead",null,[u("tr",null,[a[1]||(a[1]=u("th",{class:"practice-grid-header-cell border-b border-clay/10"},null,-1)),(h(!0),v(C,null,O(k(ur),n=>(h(),v("th",{key:n.key,class:"practice-grid-header-cell border-b border-l border-clay/10"},[u("span",qr,y(n.kana),1),u("span",Xr,y(n.romaji),1)]))),128))])]),u("tbody",null,[(h(!0),v(C,null,O(k(fr),n=>(h(),v("tr",{key:n.header.key},[u("th",Jr,[u("span",Qr,y(n.header.kana),1),u("span",Zr,y(n.header.romaji),1)]),(h(!0),v(C,null,O(n.cells,(r,o)=>(h(),v("td",{key:`${n.header.key}-${r.romaji??`empty-${o}`}`,class:"practice-grid-cell border-b border-l border-clay/10"},[r.available===!1?(h(),v("span",ei,y(r.kana),1)):(h(),v(C,{key:1},[u("span",ti,y(r.kana),1),u("span",ai,y(r.romaji),1)],64))]))),128))]))),128))])])])])).cacheIndex=0,U(1),a[0])}}),ri={class:"table-shell"},ii={class:"content-fit-table practice-long-vowel-table text-sm"},oi={key:0,class:"practice-long-vowel-rule-row"},si={colspan:"3",class:"practice-long-vowel-rule-cell"},li={class:"font-semibold text-ink"},ui={class:"text-ink/80"},fi={key:1,class:"practice-long-vowel-example-row"},ci={class:"practice-long-vowel-cell practice-long-vowel-example-cell"},di={class:"practice-kana-text practice-long-vowel-kana-text"},mi={class:"practice-long-vowel-cell practice-long-vowel-example-cell"},pi={class:"practice-long-vowel-romaji-text"},hi={class:"practice-long-vowel-cell practice-long-vowel-example-cell"},vi={class:"practice-long-vowel-translation-text"},gi=N({__name:"ChoonRuleSection",setup(e){return(t,a)=>a[0]||(U(-1,!0),(a[0]=u("section",{"data-testid":"choon-section",class:"section-card space-y-2"},[a[1]||(a[1]=u("h2",{class:"text-sm font-semibold text-ink"},"長音規則：不同拼寫形式都在提醒同一個母音要拉長。",-1)),u("div",ri,[u("table",ii,[u("tbody",null,[(h(!0),v(C,null,O(k(cr),n=>(h(),v(C,{key:n.id},[n.kind==="rule"?(h(),v("tr",oi,[u("th",si,[u("span",li,y(n.groupTitle),1),u("span",ui,"："+y(n.ruleText),1)])])):(h(),v("tr",fi,[u("td",ci,[u("span",di,y(n.example?.kana),1)]),u("td",mi,[u("span",pi,y(n.example?.romaji),1)]),u("td",hi,[u("span",vi,y(n.example?.translation),1)])]))],64))),128))])])])])).cacheIndex=0,U(1),a[0])}}),yi={class:"section-card space-y-2"},bi={class:"table-shell"},ki={class:"content-fit-table text-sm"},xi={class:"border-b border-clay/10 px-2 py-2 text-center font-semibold text-ink"},wi={class:"text-xs text-ink/60"},_i={class:"border-b border-l border-clay/10 px-3 py-2 text-left text-ink/80"},ji=N({__name:"SpecialSyllableSection",setup(e){return(t,a)=>(h(),v("section",yi,[a[0]||(a[0]=u("h2",{class:"text-sm font-semibold text-ink"},"特殊音節",-1)),u("div",bi,[u("table",ki,[u("tbody",null,[(h(!0),v(C,null,O(k(dr),n=>(h(),v("tr",{key:n.kana},[u("th",xi,[u("div",null,y(n.kana),1),u("div",wi,y(n.romaji),1)]),u("td",_i,y(n.description),1)]))),128))])])])]))}});function Be(e,t){(t==null||t>e.length)&&(t=e.length);for(var a=0,n=Array(t);a<t;a++)n[a]=e[a];return n}function Si(e){if(Array.isArray(e))return e}function Ai(e){if(Array.isArray(e))return Be(e)}function $i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Ii(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,aa(n.key),n)}}function Pi(e,t,a){return t&&Ii(e.prototype,t),Object.defineProperty(e,"prototype",{writable:!1}),e}function xe(e,t){var a=typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(!a){if(Array.isArray(e)||(a=lt(e))||t){a&&(e=a);var n=0,r=function(){};return{s:r,n:function(){return n>=e.length?{done:!0}:{done:!1,value:e[n++]}},e:function(l){throw l},f:r}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
