# n5-grammar-section-completion Specification

## Purpose

TBD - created by archiving change 'add-n5-grammar-section-completion'. Update Purpose after archive.
...
<!-- @trace
source: add-n5-grammar-section-completion
updated: 2026-04-30
code:
  - src/styles/main.css
  - src/shared/config/storageKeys.ts
  - src/modules/n5Grammar/storage/n5GrammarCompletionStorage.ts
...
tests:
  ...
  - tests/unit/n5GrammarCompletionStorage.spec.ts
