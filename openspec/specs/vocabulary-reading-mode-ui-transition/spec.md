# vocabulary-reading-mode-ui-transition Specification

## Purpose

TBD - created by archiving change 'fix-vocabulary-reading-mode-transition-jank'. Update Purpose after archive.
...
<!-- @trace
source: fix-vocabulary-reading-mode-transition-jank
updated: 2026-05-11
code:
  - bash.exe.stackdump
  - src/styles/main.css
